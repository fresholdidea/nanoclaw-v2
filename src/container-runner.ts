 ...
 *
 * `startedAtMs` is the spawn timestamp, used by the host sweep as the
 * heartbeat fallback for a container that never wrote a heartbeat file.
 */
const activeContainers = new Map<
  string,
  { process: ChildProcess; containerName: string; startedAtMs: number; deliberate?: boolean }
>();
