...
export class OpenCodeProvider implements AgentProvider {
  ...
  // No-op: OpenCode loads standing context through its own instructions
  // pipeline (see buildOpenCodeConfig `instructions`), not through this
  // file-tree memory hook. Nothing to wire here.
